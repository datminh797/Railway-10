...
VALUES			    ('Câu hỏi Java'   ,     1       ,    1   ,    1      ,'2021-05-12' ), 
					...
					('Câu hỏi Postman',     8       ,    2   ,    5      ,'2021-04-26' ),
					('Câu hỏi C++'    ,     6       ,    2   ,    5      ,'2021-05-16' ),
					('Câu hỏi C Sharp',     7       ,    2   ,    6      ,'2021-04-16' ),
					('Câu hỏi Python' ,     5       ,    2   ,    5      ,'2021-05-16' ),
					('Câu hỏi ASP.NET',     2       ,    2   ,    7      ,'2021-05-16' ),
                    ('Câu hỏi SQL'    ,     3       ,    1   ,    9      ,'2020-04-16');

UPDATE question 
SET createDate = '2021-04-12'
WHERE questionID = 10;
...
CREATE PROCEDURE dpNameAccountID (IN dpname VARCHAR(20))
BEGIN
...
DELIMITER $$
CREATE PROCEDURE TypeNameOfMaxTypeID ()
BEGIN 
WITH MaxOfTypeID AS(
SELECT 			count(typeID)
FROM			question
